...
public class ErrorTable {
	...
	/**
	 * <pre>
	 * Procedure Name: fatalError
	 * Description: Checks if a list of errors contains a fatal error
	 * 
	 * Specification reference code(s): N/A
	 * Calling Sequence: N/A
	 * 
	 * Error Conditions Tested: null pointer
	 * Error messages generated: none
	 * 
	 * Modification Log (who when and why):
	 * Michael May 22, 2012 moved from Simulator into ErrorTable
	 * 
	 ...
	 * @author Michael
	 * @param errors
	 *            are the errors to be checked
	 * @return true iff a fatal error is present
	 */
	public boolean fatalError(Set<Integer> errors) {
		// [error int local current error number]
